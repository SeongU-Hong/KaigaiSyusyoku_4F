...
public class InfoListViewAdapter extends BaseAdapter {
    ...
    ArrayList<ListItemTest> infoList = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView infoListTitle = (TextView) convertView.findViewById(R.id.infoListTitle);
        TextView infoListDate = (TextView) convertView.findViewById(R.id.infoListDate);
        TextView infoListHit = (TextView) convertView.findViewById(R.id.infoListHit);
        TextView infoListComment = (TextView) convertView.findViewById(R.id.infoListComment);

        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        ListItemTest listItemTest = infoList.get(position);
